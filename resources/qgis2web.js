...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31982',
            //extent: [-140846.589568, 6262855.763033, 627930.611720, 7002821.809500],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([389104.404266, 6450062.186687, 407335.677041, 6458763.074855], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Catálogo de Locações e Serviços</h2>';
        return titleElement;
    })(),
